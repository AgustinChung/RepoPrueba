...
public class PantallaVictoria extends JFrame {
    ...
    public PantallaVictoria() {
        ...
        setTitle("FELICIDADES - GANASTE EL JUEGO");
        setSize(750, 600);
        ...
        ImageIcon backgroundImageIcon = new ImageIcon("src/images/Tesoro.png");
        ...
        // Crear el mensaje
        JLabel mensaje = new JLabel("VICTORIA");
        ...
        background.add(panelMensaje, BorderLayout.CENTER); // Panel de mensaje en el centro
